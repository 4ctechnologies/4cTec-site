...
export default function Header() {
  return (
    <header className='flex items-center justify-between w-full p-4 bg-white dark:bg-secondary dark:text-white shadow-md fixed top-0 z-10 max-w-7xl mx-auto left-0 right-0'>
