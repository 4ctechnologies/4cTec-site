    ...
    <>
      ...
      <ul>
        <li>
          ...
          this Cookies Policy) refers to 4C Technologies, 183 Wooster St, New
        ...
        <li>
          <strong>Website</strong> refers to 4C Technologies, accessible from{" "}
          <a
            href='https://4ctechnologies.net/'
            rel='external nofollow noopener'
            target='_blank'
          >
            https://4ctechnologies.net/
          </a>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            <a
              href='https://4ctechnologies.net/contact'
              rel='external nofollow noopener'
              target='_blank'
            >
              https://4ctechnologies.net/contact
            </a>
          </p>
        </li>
      </ul>
