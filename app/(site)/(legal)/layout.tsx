...
export default function LegalLayout({
  ...
  return (
    <section className='grid grid-cols-4 gap-4 pt-40'>
      <article className='col-span-4 sm:col-span-3 flex flex-col gap-4 mx-8 p-12 border-4 border-primary rounded-lg bg-linear-to-b from-0% from-primary page'>
        {children}
      </article>
      <div className='col-span-4 sm:col-span-1 flex flex-col gap-4 mx-8 p-12 border-4 border-primary rounded-lg h-fit'>
