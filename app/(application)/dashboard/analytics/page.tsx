...
import { BarChart2, Download, TrendingUp, TrendingDown, Users, AlertTriangle, Camera } from "lucide-react"
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Performance metrics, heatmaps, and event-based statistics</p>
        </div>
        ...
        <TabsContent value="overview" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>24-hour activity across all device types</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Weekly breakdown of alerts by severity level</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[300px]">
                  <ChartContainer
                  ...
                  >
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={alertsData}>
                        ...
                        <Bar dataKey="info" fill="var(--color-info)" />
                      </BarChart>
                    </ResponsiveContainer>
                  </ChartContainer>
                </div>
        ...
        <TabsContent value="devices" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Performance metrics for all connected devices</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[400px]">
                {/* Device performance chart would go here */}
                <div className="flex items-center justify-center h-full">
                  <p className="text-muted-foreground">Device performance data visualization</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="h-[400px]">
                ...
                <div className="flex items-center justify-center h-full">
                  <p className="text-muted-foreground">Alert trends data visualization</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="h-[400px]">
                ...
                <div className="flex items-center justify-center h-full">
                  <p className="text-muted-foreground">User activity data visualization</p>
                </div>
              </div>
            </CardContent>
          </Card>
